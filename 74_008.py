...
def pumpNotFound(): # Function to handle if 74FS pump is not found
    msg = QMessageBox()
    msg.setWindowTitle("CoDE Warning")
    msg.setText("The TwisTorr 74 FS pump driver has not been found, if you want to use it, then connect it to the RS485 adapter, check that it is powered on and restart the GUI...")
    msg.setIcon(QMessageBox.Critical)
    msg.exec_()
    raise PumpNotFoundException("The TwisTorr 74 FS pump driver has not been found, if you want to use it, then connect it to the RS485 adapter, check that it is powered on and restart the GUI...")
